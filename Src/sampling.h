...
namespace shader
{
    ...
    //-----------------------------------------------------------------------
    {
        ...
        float cos_theta_t = sqrt(max(1.0f - sinThetaTSq, 0.0f));
    ...
    //-----------------------------------------------------------------------
    void sampleSphereLight(Light const& light, LightSampleRec& lightSampleRec, const float* rand_list)
    //-----------------------------------------------------------------------
    {
    ...
    //-----------------------------------------------------------------------
    void sampleRectLight(Light const& light, LightSampleRec& lightSampleRec, const float* rand_list)
    //-----------------------------------------------------------------------
    {
        float r1 = rand_list[0];
        float r2 = rand_list[1];
    ...
    //-----------------------------------------------------------------------
    void sampleLight(Light const& light, LightSampleRec& lightSampleRec, const float* rand_list)
    //-----------------------------------------------------------------------
    {
        if (int(light.type) == 0) // Rect Light
            sampleRectLight(light, lightSampleRec, rand_list);
        else
            sampleSphereLight(light, lightSampleRec, rand_list);
    }
    ...
    //-----------------------------------------------------------------------
    vec3 EmitterSample(Ray const& r, State const& state, LightSampleRec const& lightSampleRec, BsdfSampleRec const& bsdfSampleRec)
    //-----------------------------------------------------------------------
    {
        vec3 Le;
